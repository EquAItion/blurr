package com.axiom.voice.triggers.ui
...
import com.axiom.voice.BaseNavigationActivity
import androidx.recyclerview.widget.LinearLayoutManager
import androidx.recyclerview.widget.RecyclerView
import com.axiom.voice.R
import com.axiom.voice.triggers.TriggerManager
import com.axiom.voice.triggers.TriggerMonitoringService
import com.axiom.voice.triggers.TriggerType
...
class TriggersActivity : BaseNavigationActivity() {
    ...
    private fun checkNotificationPermission() {
        ...
        if (hasNotificationTriggers && !com.axiom.voice.triggers.PermissionUtils.isNotificationListenerEnabled(this)) {
    ...
    private fun showDeleteConfirmationDialog(trigger: com.axiom.voice.triggers.Trigger) {
        val dialog = AlertDialog.Builder(this)
