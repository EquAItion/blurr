...
import com.axiom.voice.triggers.PermissionUtils
import com.axiom.voice.triggers.Trigger
...
//        }
    ...
    private fun saveTrigger() {
        ...
        when (selectedTriggerType) {
            TriggerType.SCHEDULED_TIME -> {
                if (!com.axiom.voice.triggers.PermissionUtils.canScheduleExactAlarms(this)) {
