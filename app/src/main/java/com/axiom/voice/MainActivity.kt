...
import com.axiom.voice.v2.AgentService
import com.axiom.voice.utilities.FreemiumManager
import com.axiom.voice.utilities.Logger
import com.axiom.voice.utilities.OnboardingManager
import com.axiom.voice.utilities.PermissionManager
import com.axiom.voice.utilities.UserIdManager
import com.axiom.voice.utilities.UserProfileManager
import com.axiom.voice.utilities.VideoAssetManager
import com.axiom.voice.utilities.WakeWordManager
import com.axiom.voice.utilities.PandaState
import com.axiom.voice.utilities.PandaStateManager
import com.axiom.voice.utilities.DeltaStateColorMapper
import com.axiom.voice.ui.DeltaSymbolView
...
class MainActivity : BaseNavigationActivity() {
    ...
    companion object {
        const val ACTION_WAKE_WORD_FAILED = "com.axiom.voice.WAKE_WORD_FAILED"
        const val ACTION_PURCHASE_UPDATED = "com.axiom.voice.PURCHASE_UPDATED"
    }
    ...
    private fun handleIntent(intent: Intent?) {
        if (intent?.action == "com.axiom.voice.WAKE_UP_PANDA") {
        ...
        //lifecycleScope.launch {
            try {
                ...
                remoteConfig.fetchAndActivate()
                    .addOnCompleteListener(this) { task: com.google.android.gms.tasks.Task<Boolean> ->
