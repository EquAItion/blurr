...
import com.axiom.voice.api.Eyes
//import com.axiom.voice.services.AgentTaskService
import com.axiom.voice.utilities.SpeechCoordinator
...
import com.axiom.voice.agents.ClarificationAgent
import com.axiom.voice.utilities.TTSManager
import com.axiom.voice.utilities.addResponse
import com.axiom.voice.utilities.getReasoningModelApiResponse
import com.axiom.voice.data.MemoryManager
import com.axiom.voice.utilities.FreemiumManager
import com.axiom.voice.overlay.OverlayManager
import com.axiom.voice.utilities.PandaState
import com.axiom.voice.utilities.UserProfileManager
import com.axiom.voice.utilities.VisualFeedbackManager
...
import com.axiom.voice.utilities.ServicePermissionManager
...
class ConversationalAgentService : Service() {
    ...
    companion object {
        ...
        const val ACTION_STOP_SERVICE = "com.axiom.voice.ACTION_STOP_SERVICE"
        var isRunning = false
